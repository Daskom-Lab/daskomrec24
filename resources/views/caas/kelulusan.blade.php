...
<body class="bg-dark-dungeon bg-cover bg-fixed bg-no-repeat bg-center cursor-sword">
   ...
   <div class="container relative max-w-2xl mx-auto py-5">
        <div class="flex justify-center">
            <img src="/public/assets/dashboardcaas/announcement.png" alt="" class="paper h-[460px] w-[310px]">
        </div>
        ...
        <div class="text-announce absolute top-[20px] left-0 right-0 text-center mt-[85px] z-10"> 
            ...
            <p class="announcement text-secondary text-[12px] text-justify max-w-[250px] mx-auto font-vinque">
                Selamat!!! <br>
                Kamu dinyatakan lolos pada tahap __. Dengan ini kami menunggu
                kamu untuk mengikuti rangkaian recruitment selanjutnya.
                <br><br>
                Silahkan untuk mengisi jadwal tahap selanjutnya.
            </p>
            
            <a href="#">
                <button class="button-schedule mt-[130px] mb-0 text-secondary font-semibold font-Blackha text-[12px] bg-coklat-muda px-4 py-2 shadow-secondary shadow-xl hover:text-coklat-terang hover:bg-primary">
                    SCHEDULE
                </button>
            </a>
        </div> 
