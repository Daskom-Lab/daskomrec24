            ...
            <form class="flex flex-col justify-around items-center h-3/5" action="{{ route('caas.login.check') }}" method="post">
                ...
                <div class="flex flex-col items-center justify-between font-vinque h-60 font-bold">
                    <input type="text" placeholder="enter your nim" name="nim" id="nim"
                        class="mt-[115px] w-60 h-16 text-[#514D4D] border-b-gray-700 border-b-2 bg-transparent focus:outline-none invalid:border-b-gray-500 text-sm text-center placeholder:text-[#514D4D] transition-all duration-300 ease-in-out" required />
                        @error('nim')
                    ...
                    <input placeholder="enter your password" name="password" id="password" type="password"
                        class="mt-8 w-60 h-16 text-[#514D4D] border-b-gray-700 border-b-2 bg-transparent focus:outline-none invalid:border-b-gray-500 text-sm text-center placeholder:text-[#514D4D] transition-all duration-300 ease-in-out" required />
                        @error('password')
                        <div class="alert alert-danger mt-2 text-red-600 text-[11px] text-center justify-center">
                            please 8 karakter
                        </div>
                    ...
                    <button type="submit"
                        class="mt-9 w-[160px] h-28 shadow-semi-sm active:shadow-in-semi-sm active:shadow-bright-sun duration-200">
