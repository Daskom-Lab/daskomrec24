...
<body class="bg-dark-dungeon bg-cover bg-fixed bg-no-repeat bg-center cursor-sword">
   ...
   <div class="container flex justify-between">
    ...
    <div class="container relative max-w-3xl mx-auto py-2"> 
            ...
            <table class="table-auto text-[12px] lg:text-[15px] tracking-wide font-ringbearer">
                <thead class="header">
                    <tr class="tabel bg-dark text-fivedary">
                        ...
                        <th class="border border-butter px-2 lg:px-4 py-2">hari, tanggal</th>
                ...
                <tbody class="bg-light text-fivedary text-[10px] lg:text-[13px] table-auto">
                    <tr>
                        <th class="border border-butter px-2 lg:px-4 py-2">1.</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">shift 1</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">3 februari</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">06.30 - 09.00</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">12</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">
                            <button class="bg-dark hover:bg-gray-dark px-2 py-1 rounded-md">
                             pilih
                            </button>
                            </th>
                    </tr>
                    <tr>
                        <th class="border border-butter px-2 lg:px-4 py-2">2.</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">shift 3</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">3 februari</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">13.30 - 15.00</th>
                        <th class="border border-butter px-2 lg:px-4 py-2 text-butter">penuh</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">
                            <button class="bg-gray-dark bg-blur px-2 py-1 rounded-md">
                            pilih
                            </button>
                            </th>
                    </tr>  
                    <tr>
                        <th class="border border-butter px-2 lg:px-4 py-2">3.</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">shift 3</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">12 februari</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">16.30 - 19.00</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">5</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">
                            <button class="bg-dark hover:bg-gray-dark px-2 py-1 rounded-md">
                                <a href="fixjadwal.html">
                                    pilih
                                </a>
                            </button>
                            </th>
                    ...
                    <tr>
                        <th class="border border-butter px-2 lg:px-4 py-2">4.</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">shift 4</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">21 februari</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">06.30 - 10.00</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">8</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">
                            <button class="bg-dark hover:bg-gray-dark px-2 py-1 rounded-md">
                            pilih
                            </button>
                    ...
                    <tr>
                        <th class="border border-butter px-2 lg:px-4 py-2">5.</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">shift 4</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">26 februari</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">13.30 - 15.00</th>
                        <th class="border border-butter px-2 lg:px-4 py-2 text-butter">penuh</th>
                        <th class="border border-butter px-2 lg:px-4 py-2">
                            <button class="bg-gray-dark bg-blur px-2 py-1 rounded-md">
        ...
        <div class="text-white font-ringbearer mt-6 flex justify-center gap-x-6">
            <a href="#">
                <button class="text-[16px] bg-light hover:bg-dark px-3 py-2 rounded-sm">
                    previous
                </button>
            </a>
            <a href="#">
                <button class="text-[16px] bg-light hover:bg-dark px-7 py-2 rounded-sm">
                    next
                </button >
            </a>
        </div>
