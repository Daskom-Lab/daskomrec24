...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login | Admin DLOR 2024</title>
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-dark p-4">
                                            <h5 class="text-dark">Welcome Adversaries!!</h5>
                                            <p>Sign in to make them cry.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="post" action="{{ route('admin.login.check') }}">
                                        {{ csrf_field() }}
                                        <div class="mb-3">
                                            <label for="ascode" class="form-label">Assistant Code</label>
                                            <input type="text" maxlength="3" class="form-control" id="ascode" oninput="this.value = this.value.toUpperCase();" style="text-transform: uppercase;" placeholder="DII" name="ascode" autofocus required>
                                        </div>
